...
async def startup_event():
    ...
    Side effects:
        Calls the unresolved init_db, checks Firestore connectivity, and
        writes caught failures to stdout.
    """
...
async def shutdown_event():
    ...
    Raises:
        AttributeError: The Firestore client does not define close.
    """
