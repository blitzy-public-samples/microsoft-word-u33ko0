...
- **The three specification documents under `../documentation/`.** All three predate this
  ...
  line number, following the convention this set's index states at `README.md:L95-L98`.
...
`../infrastructure/docker/README.md:L9` states that none of the three container artifacts works as
...
and 15 `TODO` comment lines on both sides. The pass obscured none of them.

Block extraction found 191 documentation blocks at the current branch head: 73 Python docstrings, 98
JSDoc blocks and 20 Terraform comment runs. The scored-unit and prose-sentence totals in
[the inline row](#the-inline-documentation-pass) were taken at commit `2136ae4`. Five JSDoc blocks
were consolidated into their neighbours after that, so both totals read as a floor rather than an
...
| --- | --- | --- | --- | --- | --- | --- |
| [backend/app/README.md](../backend/app/README.md) | 392 | 480 | 30 | 5 | 1 | CLEAN |
| [backend/app/api/README.md](../backend/app/api/README.md) | 397 | 453 | 30 | 5 | 0 | CLEAN |
| [backend/app/core/README.md](../backend/app/core/README.md) | 346 | 367 | 30 | 5 | 2 | CLEAN |
| [backend/app/db/README.md](../backend/app/db/README.md) | 259 | 288 | 29 | 5 | 0 | CLEAN |
| [backend/app/schema/README.md](../backend/app/schema/README.md) | 214 | 235 | 28 | 5 | 0 | CLEAN |
| [backend/app/services/README.md](../backend/app/services/README.md) | 397 | 380 | 30 | 5 | 3 | CLEAN |
| [backend/app/tasks/README.md](../backend/app/tasks/README.md) | 364 | 379 | 30 | 5 | 0 | CLEAN |
...
| [frontend/src/components/README.md](../frontend/src/components/README.md) | 399 | 343 | 30 | 5 | 0 | CLEAN |
| [frontend/src/pages/README.md](../frontend/src/pages/README.md) | 366 | 340 | 30 | 5 | 0 | CLEAN |
| [frontend/src/schema/README.md](../frontend/src/schema/README.md) | 205 | 234 | 29 | 5 | 0 | CLEAN |
| [frontend/src/services/README.md](../frontend/src/services/README.md) | 229 | 329 | 30 | 5 | 2 | CLEAN |
| [frontend/src/store/README.md](../frontend/src/store/README.md) | 255 | 306 | 28 | 5 | 0 | CLEAN |
| [frontend/src/utils/README.md](../frontend/src/utils/README.md) | 196 | 158 | 30 | 5 | 1 | CLEAN |
| [infrastructure/terraform/README.md](../infrastructure/terraform/README.md) | 398 | 400 | 30 | 5 | 2 | CLEAN |
...
| [scripts/README.md](../scripts/README.md) | 268 | 318 | 30 | 5 | 2 | CLEAN |

The 19 files hold 5,736 physical lines, and 20 of the 94 charged violations sat in this group. Every
one of the 19 lands inside the band, with 46 lines of headroom at the short end and one line at the
long end. The file closest to the ceiling is
[frontend/src/components/README.md](../frontend/src/components/README.md), at 399 lines against a
400-line ceiling. A paragraph added there has to replace text rather than extend
the file.
...
| [troubleshooting.md](troubleshooting.md) | 1,850 | 2,789 | 30 | 5 | 25 | CLEAN |
| [onboarding.md](onboarding.md) | 1,098 | 775 | 30 | 5 | 12 | CLEAN |
| [decision-log.md](decision-log.md) | 779 | 2,345 | 29 | 5 | 14 | CLEAN |
| [prose-validation.md](prose-validation.md) | 1,545 | 2,204 | 30 | 5 | 6 | CLEAN |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| The inline documentation pass: 15 Python modules under `../backend/app/`, 26 TypeScript and TSX modules under `../frontend/src/`, 3 Terraform files under `../infrastructure/terraform/` | 1,956 | 665 | 953 | 30 | 5 | 5 | CLEAN |

Four properties of the row need stating, because the pass is measured differently from a Markdown
...
Two measurement dates sit in the row, as they do in the two tables above. Added comment lines is
measured at the current branch head, where the 44 modified source files carry 1,956 inserted lines
and no deleted line against base commit `06be74c`. Scored units, Prose sentences, Longest sentence
and Longest unit were measured at commit `2136ae4`. Commits after that one consolidated five JSDoc
blocks into their neighbours and added 82 further comment lines, so the two totals read as a floor.
...
| backend/app/services/README.md | Pass | Pass | Pass, 3 | Pass | Pass | Pass | Pass | Pass |
...
| infrastructure/terraform/README.md | Pass | Pass, 1 | Pass | Pass | Pass | Pass | Pass, 1 | Pass |
| infrastructure/docker/README.md | Pass | Pass, 2 | Pass, 3 | Pass | Pass | Pass | Pass | Pass |
...
| docs/README.md | Pass | Pass, 1 | Pass | Pass | Pass | Pass | Pass | Pass |
| docs/architecture-overview.md | Pass | Pass | Pass, 1 | Pass | Pass | Pass | Pass | Pass |
...
| docs/deployment-guide.md | Pass | Pass, 1 | Pass, 2 | Pass | Pass | Pass | Pass | Pass |
| docs/troubleshooting.md | Pass | Pass, 5 | Pass, 12 | Pass | Pass | Pass | Pass, 8 | Pass |
| docs/onboarding.md | Pass | Pass, 1 | Pass, 1 | Pass | Pass | Pass | Pass, 10 | Pass |
| docs/decision-log.md | Pass | Pass | Pass, 9 | Pass | Pass | Pass | Pass, 5 | Pass |
| docs/prose-validation.md | Pass | Pass | Pass, 2 | Pass | Pass | Pass | Pass, 4 | Pass |
...
[troubleshooting.md](troubleshooting.md) at 1,850 lines is the longest deliverable and the strongest
...
| backend/app/services/README.md | Pass | Pass, 3 | Pass | Pass | Pass | Pass | n/a | Pass | Pass | Pass |
...
| docs/architecture-overview.md | Pass | Pass, 1 | Pass | Pass | Pass | Pass | n/a | Pass | Pass | Pass |
...
| docs/troubleshooting.md | Pass | Pass, 12 | Pass | Pass | Pass | Pass | n/a | Pass | Pass | Pass |
| docs/onboarding.md | Pass | Pass, 1 | Pass | Pass | Pass | Pass | n/a | Pass | Pass | Pass |
| docs/decision-log.md | Pass | Pass, 9 | Pass | Pass | Pass | Pass | n/a | Pass | Pass | Pass |
| docs/prose-validation.md | Pass | Pass, 2 | Pass | Pass | Pass | Pass | n/a | Pass | Pass | Pass |
...
| [../backend/app/services/README.md](../backend/app/services/README.md) | V3, A2 | A 38-word sentence in the `connect` cell at `:L27` | 3, 4, 76 |
...
| [../infrastructure/terraform/README.md](../infrastructure/terraform/README.md) | V2, V7 | A 6-sentence dead-variable list item at `:L206`, plus a static-check section reporting `terraform fmt -check` as clean | 45, 83 |
| [../infrastructure/docker/README.md](../infrastructure/docker/README.md) | V2, V3, A2 | A 40-word sentence in the containment cell at `:L203` | 8, 9, 10, 77 |
...
| [README.md](README.md) | V2 | A 6-sentence diagram-style paragraph at `:L109` | 78 |
| [architecture-overview.md](architecture-overview.md) | V3, A2 | A 35-word sentence in the updated-line-count paragraph at `:L101` | 79 |
...
| [deployment-guide.md](deployment-guide.md) | V2, V3, A2 | A 39-word sentence in the containment risk row at `:L415` | 16, 17, 80 |
| [troubleshooting.md](troubleshooting.md) | V2, V3, A2, V7 | A 46-word sentence in the `starlette` risk row at `:L531` | 18-25, 34-41, 68-73 |
| [onboarding.md](onboarding.md) | V2, V3, A2, V7 | An 8-sentence bullet at `:L66` holding a 34-word sentence | 26, 47-56 |
| [decision-log.md](decision-log.md) | V3, A2, V7 | A 46-word sentence in decision row 19 at `:L99` | 27-30, 57-61, 74, 75 |
| [prose-validation.md](prose-validation.md) | V3, A2, V7 | A 34-word sentence in the entry 22a ownership note, plus seven line counts that no longer matched the files they described | 62-65, 81, 82 |
| The inline documentation pass | V3, A2, V7 | A 33-word sentence in the `connect` docstring | 31-33, 66, 67 |

Nine deliverables carried no charge at all, and all nine are module READMEs:
...
[../frontend/src/store/README.md](../frontend/src/store/README.md). Every one of the nine `docs/`
documents carried at least one charge, and so did the inline documentation pass. None of the nine
uncharged files was skipped, and each was measured by the same checks and returned no finding.
...
| V10 | The Indifference Detector | Pass, all 29 | [troubleshooting.md](troubleshooting.md) at 1,850 lines is the strongest candidate in the corpus. The file survives the test because it hands the reader a route in. A four-sentence failure summary sits at `:L3-L6`, then a symptom-first index whose own instruction at `troubleshooting.md` `L36` reads "Read the index to find your problem." All 19 module READMEs sit inside the 150-to-400-line band |
...
| A9 | Efficiency Over Polish | Pass, all 29 | The inline documentation pass is the candidate. Added comment lines account for 1,057 of the 1,717 lines across the 15 Python modules, 62 percent, and 856 of the 1,825 across the 26 TypeScript modules, 47 percent. The volume tracks a per-construct requirement against an unusually high defect density rather than restatement |
...
### Entry 2. `../backend/app/core/README.md:L246`, V2, 6 sentences
...
| 45 | `../infrastructure/terraform/` `README.md:L324` | The static-check section opened "One command here is safe", and `:L386` reported only that the command "exits non-zero" | `:L322` reads "The check **exits 3**", `:L328` shows `terraform fmt -check -diff`, and `:L337` adds an exit-code table for all three commands | A reader running the command as the only safe one met a nonzero exit with no explanation, and the whole difference is two whitespace-only lines at `main.tf:L53` and `:L55` |
| 46 | `../backend/app/core/` `README.md:L268` | The marker note cited "a four-line `HUMAN ASSISTANCE NEEDED` block at `security.py:L88-L91`" | `../backend/app/core/` `README.md:L270` cites `security.py` `L106-L109` | The block sat at `L84-L87` when the claim was written, so the locator was wrong by two lines before the inline pass moved it at all |
| 47 | `onboarding.md:L3-L4` | "Two commands succeed on a clean machine, a third runs to completion and exits nonzero by design" | `:L3-L5` read "Five commands produce a result on a clean machine. Two succeed, two report failure by design, and the development server serves the client while compilation fails" | The guide's own results table carries five rows, so the opening undercounted the commands a reader is about to run |
...
| 54 | `onboarding.md:L576` | "no single `PYTHONPATH` value clears the first" | `:L641` reads "no single directory on `PYTHONPATH` clears the first" | One `PYTHONPATH` value can hold several directories, so the drafted claim was false as written while the point behind it holds |
| 55 | `onboarding.md:L789` | "**The invisible six.**" introduced the packages an import-reading developer would miss | `:L858` reads "**The invisible seven.**", and separates the three transitive arrivals from the four a configuration value selects | The list beneath it names four configuration-selected distributions and three transitive ones, so the count was one short of its own contents |
...
| 62 | `prose-validation.md`, seven rows of the verdict tables | Seven line counts described files that had grown or shrunk since the counts were taken, including `troubleshooting.md` at 1,662 lines | The verdict tables now carry measurements taken at the current branch head, with `troubleshooting.md` at 1,850 lines | A validation record whose own measurements are stale cannot be used to check anything, which is the failure it exists to prevent |
| 63 | `prose-validation.md`, the module totals and the band headroom | The totals read 5,652 lines and a range of "196 to 396", with 4 lines of headroom at the long end | The totals read 5,736 lines and a range of 196 to 399, with one line of headroom at the long end | Three lines of headroom is the difference between a paragraph that fits and one that pushes a README past the band |
...
Sixty-three sentences run exactly 30 words. The densest is at `../backend/app/api/README.md:L139`,
which names four actors in one chain and still resolves on one reading. Two hundred and twenty-seven
...
One deliverable sits one line inside its band ceiling.
[../frontend/src/components/README.md](../frontend/src/components/README.md) measures 399 lines
...
at entry 45 was written to that constraint in the Terraform file, and two sentences there paid for
it.
