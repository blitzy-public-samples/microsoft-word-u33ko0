...
| `get_password_hash` | `backend/app/core/security.py:L88` | `backend/app/core` | Docstring; the bcrypt context duplicated from the auth router | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `get_current_user` | `backend/app/core/security.py:L119` | `backend/app/core` | Docstring plus a usage example; three undefined names recorded | `integration-guide.md`, `onboarding.md` | COVERED |
...
| `export default Templates` | `frontend/src/pages/Templates.tsx:L115` | `frontend/src/pages` | JSDoc on the component above; routed at `/templates` | `architecture-overview.md` | COVERED |
...
| `HUMAN ASSISTANCE NEEDED` at `security.py:L115`, flagging the token dependency's undefined `User` and `UserService` names | `backend/app/core/security.py:L115-L118` | `backend/app/core` | Preserved verbatim; referenced by the surrounding documentation | `troubleshooting.md`, `integration-guide.md` | COVERED |
...
| `HUMAN ASSISTANCE NEEDED` at `Templates.tsx:L66`, flagging absent error handling, paired with the TODO on the next line | `frontend/src/pages/Templates.tsx:L66-L67` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `data-model.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `Templates.tsx:L83`, flagging absent navigation, paired with the TODO on the next line | `frontend/src/pages/Templates.tsx:L83-L84` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `data-model.md`, `troubleshooting.md` | COVERED |
...
| `TODO` at `Templates.tsx:L67`: implement error handling and user feedback | `frontend/src/pages/Templates.tsx:L67` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `data-model.md`, `troubleshooting.md` | COVERED |
| `TODO` at `Templates.tsx:L84`: implement navigation after a template is chosen | `frontend/src/pages/Templates.tsx:L84` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `data-model.md`, `troubleshooting.md` | COVERED |
