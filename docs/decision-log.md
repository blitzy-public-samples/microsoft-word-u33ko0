...
| C3 | Rule 2 requires a path from a clean machine to a running application. The application does not run: `import app.main` fails at `backend/app/api/auth.py:L20`. | [onboarding.md](onboarding.md) documents the working steps, the exact stopping point with evidence, and the remediation each blocker needs. | 3 |
...
| `api/auth.py` | `backend/app/api/auth.py:L1-L18` | `backend/app/api` | Module docstring; records the duplicated `get_current_user` | `integration-guide.md`, `troubleshooting.md` | COVERED |
...
| `core/security.py` | `backend/app/core/security.py:L1-L22` | `backend/app/core` | Module docstring; three undefined names, and `jwt.JWTError` confirmed sound | `integration-guide.md`, `troubleshooting.md` | COVERED |
...
| Source Construct | Location | Documenting README | Inline Documentation | `docs/` Coverage | Status |
| --- | --- | --- | --- | --- | --- |
| `Settings` | `backend/app/core/config.py:L20` | `backend/app/core` | Class docstring listing all nine fields as `Attributes:`. Its inner `Config` at `:L50` carries a class docstring recording that it points Pydantic at an uncommitted `.env` | `deployment-guide.md`, `onboarding.md` | COVERED |
...
| `DocumentUpdate` | `backend/app/schema/document.py:L40` | `backend/app/schema` | Class docstring; does not inherit `DocumentBase` | `data-model.md`, `troubleshooting.md` | COVERED |
| `Document` | `backend/app/schema/document.py:L52` | `backend/app/schema` | Class docstring; required timestamps no service writes | `data-model.md`, `troubleshooting.md` | COVERED |
| `DocumentVersion` | `backend/app/schema/document.py:L67` | `backend/app/schema` | Class docstring; names its actor `user_id` | `data-model.md`, `troubleshooting.md` | COVERED |
...
| `User` | `backend/app/schema/user.py:L56` | `backend/app/schema` | Class docstring; flags no code path reads. Its inner `Config` at `:L74` carries a class docstring recording that `orm_mode` pins Pydantic to 1.x | `data-model.md`, `troubleshooting.md`, `onboarding.md` | COVERED |
...
| Source Construct | Location | Documenting README | Inline Documentation | `docs/` Coverage | Status |
| --- | --- | --- | --- | --- | --- |
| `get_current_user` | `backend/app/api/auth.py:L28` | `backend/app/api` | Docstring; duplicate of the `core` version, and returns 404 where `core` returns 401 | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `login_for_access_token` | `backend/app/api/auth.py:L67` | `backend/app/api` | Docstring with `Args:`, `Returns:` and `Raises:`; one of the two public handlers | `integration-guide.md`, `onboarding.md` | COVERED |
| `register_user` | `backend/app/api/auth.py:L104` | `backend/app/api` | Docstring; hashes a password the `User` contract cannot store | `data-model.md`, `troubleshooting.md` | COVERED |
...
| `update_document` | `backend/app/api/documents.py:L99` | `backend/app/api` | Docstring; reads `document.user_id` off a schema declaring `owner_id` | `data-model.md`, `troubleshooting.md` | COVERED |
| `delete_document` | `backend/app/api/documents.py:L132` | `backend/app/api` | Docstring; same arity and field defects as the read handler | `data-model.md`, `troubleshooting.md` | COVERED |
...
| `get_current_user_info` | `backend/app/api/users.py:L20` | `backend/app/api` | Docstring; declared `def`, as is the other handler in this module, while all twelve handlers in the other three routers are `async def` | `data-model.md`, `troubleshooting.md` | COVERED |
| `update_user` | `backend/app/api/users.py:L33` | `backend/app/api` | Docstring; the module's second synchronous `def` handler, and it awaits nothing and persists nothing | `data-model.md`, `troubleshooting.md` | COVERED |
| `get_settings` | `backend/app/core/config.py:L63` | `backend/app/core` | Docstring with `Returns:` and `Raises:`; carries no caching decorator | `deployment-guide.md`, `onboarding.md` | COVERED |
| `create_access_token` | `backend/app/core/security.py:L27` | `backend/app/core` | Docstring plus a usage example, as a named primary entry point | `integration-guide.md`, `onboarding.md` | COVERED |
| `verify_password` | `backend/app/core/security.py:L59` | `backend/app/core` | Docstring with `Args:` and `Returns:`; bcrypt comparison | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `get_password_hash` | `backend/app/core/security.py:L86` | `backend/app/core` | Docstring; the bcrypt context duplicated from the auth router | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `get_current_user` | `backend/app/core/security.py:L110` | `backend/app/core` | Docstring plus a usage example; three undefined names recorded | `integration-guide.md`, `onboarding.md` | COVERED |
...
| `delete_document` | `backend/app/db/firestore.py:L81` | `backend/app/db` | Docstring; synchronous, and consumed by no service | `data-model.md`, `integration-guide.md` | COVERED |
...
| `CollaborationService.disconnect` | `backend/app/services/collaboration_service.py:L107` | `backend/app/services` | Docstring; removes the socket from a per-process dictionary | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `CollaborationService.broadcast_change` | `backend/app/services/collaboration_service.py:L137` | `backend/app/services` | Docstring; blocking `future.result()` inside an async method | `integration-guide.md`, `troubleshooting.md` | COVERED |
...
| `components/TextEditor.tsx` | `frontend/src/components/TextEditor.tsx:L1` | `frontend/src/components` | File header; presented as the argument-count reference only | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| `Header` | `frontend/src/components/Header.tsx:L29` | `frontend/src/components` | Component JSDoc; absent logo asset and two undeclared routes | `architecture-overview.md`, `troubleshooting.md` | COVERED |
| `ImageEditor` | `frontend/src/components/ImageEditor.tsx:L28` | `frontend/src/components` | Component JSDoc; no block renderer, so an atomic image never renders | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| `TableEditor` | `frontend/src/components/TableEditor.tsx:L27` | `frontend/src/components` | Component JSDoc; renders an empty element | `architecture-overview.md`, `troubleshooting.md` | COVERED |
| `TextEditor` | `frontend/src/components/TextEditor.tsx:L23` | `frontend/src/components` | Component JSDoc; the argument-count contract and the inline mismatch | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| `export default Header` | `frontend/src/components/Header.tsx:L65` | `frontend/src/components` | JSDoc on the component above; named-imported by three pages | `architecture-overview.md`, `troubleshooting.md` | COVERED |
| `export default ImageEditor` | `frontend/src/components/ImageEditor.tsx:L66` | `frontend/src/components` | JSDoc on the component above; no module imports it | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| `export default TableEditor` | `frontend/src/components/TableEditor.tsx:L74` | `frontend/src/components` | JSDoc on the component above; no module imports it | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| `export default Editor` | `frontend/src/pages/Editor.tsx:L119` | `frontend/src/pages` | JSDoc on the component above; routed at `/editor` | `architecture-overview.md` | COVERED |
...
| `export default Templates` | `frontend/src/pages/Templates.tsx:L113` | `frontend/src/pages` | JSDoc on the component above; routed at `/templates` | `architecture-overview.md` | COVERED |
...
| `createDocument` | `frontend/src/services/api.ts:L82` | `frontend/src/services` | JSDoc with `@param` and `@returns`; same prefix mismatch | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `updateDocument` | `frontend/src/services/api.ts:L95` | `frontend/src/services` | JSDoc with `@param` and `@returns`; same prefix mismatch | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `login` | `frontend/src/services/auth.ts:L35` | `frontend/src/services` | JSDoc; posts to `/auth/login`, which no server route matches | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `logout` | `frontend/src/services/auth.ts:L53` | `frontend/src/services` | JSDoc; posts to `/auth/logout`, which no server route matches | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `getCurrentUser` | `frontend/src/services/auth.ts:L70` | `frontend/src/services` | JSDoc; unchecked cast to `User` | `data-model.md`, `troubleshooting.md` | COVERED |
| `export default CollaborationService` | `frontend/src/services/collaboration.ts:L109` | `frontend/src/services` | JSDoc on the class and all three methods; never instantiated | `integration-guide.md`, `troubleshooting.md` | COVERED |
| Six document actions: `setCurrentDocument`, `addRecentDocument`, `setLoading`, `setError`, `clearCurrentDocument`, `clearRecentDocuments` | `frontend/src/store/documentSlice.ts:L117-L124` | `frontend/src/store` | JSDoc per action with a usage example, as named primary entry points | `architecture-overview.md`, `data-model.md` | COVERED |
| `export default documentSlice.reducer` | `frontend/src/store/documentSlice.ts:L127` | `frontend/src/store` | JSDoc; the store imports a named `documentReducer` instead | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| Four user actions: `setUser`, `clearUser`, `setLoading`, `setError` | `frontend/src/store/userSlice.ts:L97` | `frontend/src/store` | JSDoc per action with a usage example, as named primary entry points | `architecture-overview.md`, `data-model.md` | COVERED |
| `export default userSlice.reducer` | `frontend/src/store/userSlice.ts:L100` | `frontend/src/store` | JSDoc; the store imports a named `userReducer` instead | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| `HUMAN ASSISTANCE NEEDED` at `security.py:L106`, flagging the token dependency's undefined `User` and `UserService` names | `backend/app/core/security.py:L106-L109` | `backend/app/core` | Preserved verbatim; referenced by the surrounding documentation | `troubleshooting.md`, `integration-guide.md` | COVERED |
...
| `HUMAN ASSISTANCE NEEDED` at `collaboration_service.py:L135`, flagging `broadcast_change`, at a stated confidence of 0.7 | `backend/app/services/collaboration_service.py:L135-L136` | `backend/app/services` | Preserved verbatim; referenced by the surrounding documentation | `integration-guide.md`, `troubleshooting.md` | COVERED |
...
| `HUMAN ASSISTANCE NEEDED` at `ImageEditor.tsx:L29`, flagging the atomic-block insert helper | `frontend/src/components/ImageEditor.tsx:L29-L30` | `frontend/src/components` | Preserved verbatim; referenced by the surrounding documentation | `architecture-overview.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `ImageEditor.tsx:L58`, flagging the unwritten image-editing interface | `frontend/src/components/ImageEditor.tsx:L58-L59` | `frontend/src/components` | Preserved verbatim; referenced by the surrounding documentation | `architecture-overview.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `TableEditor.tsx:L28`, flagging the table insert helper, at a stated confidence of 0.6 | `frontend/src/components/TableEditor.tsx:L28-L29` | `frontend/src/components` | Preserved verbatim; referenced by the surrounding documentation | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| `HUMAN ASSISTANCE NEEDED` at `Templates.tsx:L64`, flagging absent error handling, paired with the TODO on the next line | `frontend/src/pages/Templates.tsx:L64-L65` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `data-model.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `Templates.tsx:L81`, flagging absent navigation, paired with the TODO on the next line | `frontend/src/pages/Templates.tsx:L81-L82` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `data-model.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `collaboration.ts:L50`, flagging the empty listener body, with an example listener commented out | `frontend/src/services/collaboration.ts:L50-L53` | `frontend/src/services` | Preserved verbatim; referenced by the surrounding documentation | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `collaboration.ts:L56`, flagging `joinDocument` | `frontend/src/services/collaboration.ts:L56-L57` | `frontend/src/services` | Preserved verbatim; referenced by the surrounding documentation | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `collaboration.ts:L83`, flagging `sendChanges` | `frontend/src/services/collaboration.ts:L83-L84` | `frontend/src/services` | Preserved verbatim; referenced by the surrounding documentation | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `documentSlice.ts:L129`, flagging absent thunks for asynchronous document operations | `frontend/src/store/documentSlice.ts:L129-L132` | `frontend/src/store` | Preserved verbatim; referenced by the surrounding documentation | `architecture-overview.md`, `troubleshooting.md` | COVERED |
| `HUMAN ASSISTANCE NEEDED` at `userSlice.ts:L102`, flagging absent error types and the absent `updateUser` action | `frontend/src/store/userSlice.ts:L102-L105` | `frontend/src/store` | Preserved verbatim; referenced by the surrounding documentation | `architecture-overview.md`, `troubleshooting.md` | COVERED |
...
| `TODO` at `main.py:L72`: add additional shutdown cleanup | `backend/app/main.py:L72` | `backend/app` | Preserved verbatim; referenced by the surrounding documentation | `deployment-guide.md`, `troubleshooting.md` | COVERED |
...
| `TODO` at `Editor.tsx:L54`: add proper error handling on document load | `frontend/src/pages/Editor.tsx:L54` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `integration-guide.md`, `troubleshooting.md` | COVERED |
| `TODO` at `Editor.tsx:L87`: add error handling and user notification on auto-save | `frontend/src/pages/Editor.tsx:L87` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `integration-guide.md`, `troubleshooting.md` | COVERED |
...
| `TODO` at `Templates.tsx:L65`: implement error handling and user feedback | `frontend/src/pages/Templates.tsx:L65` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `data-model.md`, `troubleshooting.md` | COVERED |
| `TODO` at `Templates.tsx:L82`: implement navigation after a template is chosen | `frontend/src/pages/Templates.tsx:L82` | `frontend/src/pages` | Preserved verbatim; referenced by the surrounding documentation | `data-model.md`, `troubleshooting.md` | COVERED |
...
| Source Construct | Location | Documenting README | Inline Documentation | `docs/` Coverage | Status |
| --- | --- | --- | --- | --- | --- |
| `POST /token` | `backend/app/api/auth.py:L66` | `backend/app/api` | Handler docstring at `:L67`; one of the two public operations | `integration-guide.md`, `onboarding.md` | COVERED |
| `POST /register` | `backend/app/api/auth.py:L103` | `backend/app/api` | Handler docstring at `:L104`; the second public operation | `integration-guide.md`, `onboarding.md` | COVERED |
...
| `PUT /{document_id}` | `backend/app/api/documents.py:L98` | `backend/app/api` | Handler docstring at `:L99`; protected, and shadows the template update | `data-model.md`, `troubleshooting.md` | COVERED |
| `DELETE /{document_id}` | `backend/app/api/documents.py:L131` | `backend/app/api` | Handler docstring at `:L132`; protected, and shadows the template delete | `data-model.md`, `troubleshooting.md` | COVERED |
...
| `SECRET_KEY`, DECLARED | `backend/app/core/config.py:L42` | `backend/app/core` | Documented; read at `backend/app/core/security.py:L56` and in the auth router | `integration-guide.md`, `onboarding.md` | COVERED |
| `ACCESS_TOKEN_EXPIRE_MINUTES`, DECLARED | `backend/app/core/config.py:L43` | `backend/app/core` | Documented; read at `backend/app/core/security.py:L54` | `integration-guide.md`, `onboarding.md` | COVERED |
...
| `ALLOWED_ORIGINS`, READ BUT NEVER DECLARED | `backend/app/main.py:L77` | `backend/app` | Documented in the module docstring as absent from the `Settings` model | `deployment-guide.md`, `troubleshooting.md` | COVERED |
| `PROJECT_ID`, READ BUT NEVER DECLARED | `backend/app/services/collaboration_service.py:L69` | `backend/app/services` | Documented; also read at `:L128` and `:L153` | `integration-guide.md`, `troubleshooting.md` | COVERED |
