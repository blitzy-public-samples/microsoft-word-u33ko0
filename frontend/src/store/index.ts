 ...
 *
 * @remarks
 * `@reduxjs/toolkit` is declared in `frontend/package.json`, so `configureStore` resolves. Every
 * failure below is a local naming problem rather than a missing dependency.
 *
