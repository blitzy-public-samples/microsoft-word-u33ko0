 ...
 *
 * Each function takes two arguments. `frontend/src/components/TextEditor.tsx:L17` and `:L24` pass
 * both. `frontend/src/components/Toolbar.tsx:L14` and `:L19` pass one argument each, which binds
 ...
 * `'apply-inline-style'`.
 * @remarks
 * The function requires both arguments. `frontend/src/components/TextEditor.tsx:L17` passes both.
 ...
 * @param editorState - Editor state supplying the content and selection, read through
 * `getCurrentContent()` and `getSelection()`.
 * @param blockType - Block type name handed to `Modifier.setBlockType`, such as `'header-one'`.
 * @returns A new `EditorState` from `EditorState.push`, carrying the change type
 * `'change-block-type'`.
 * @remarks
 * The function requires both arguments. `frontend/src/components/TextEditor.tsx:L24` passes both.
